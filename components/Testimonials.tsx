...
function Testimonials() {
  return (
    <>
    {/* First*/}
      {/* <div className="flex flex-col md:flex-row items-center md:items-start px-8 md:px-20 py-10">
        <div className="md:w-1/2 md:py-28">
          <div className="text-left text-5xl font-bold font-serif text-[#2e657a]">
            What our Customers think
          </div>
          <div className="text-left text-lg py-14 text-slate-500">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure
            provident necessitatibus ducimus esse sit eveniet earum mollitia sed
            dolores tenetur reiciendis cumque, quo quidem natus distinctio vel
            nisi et suscipit.
          </div>
        </div>
        <div className="md:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-5">
          <PixelCard variant="default" className="bg-black p-5">
     ...
     {/* Fourth*/}
     <section className="py-12 bg-gray-50 sm:py-16 lg:py-20 bg-[url('https://pagedone.io/asset/uploads/1691055810.png')] bg-center bg-cover h-screen">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
            <div className="text-center">
                ...
                <h2 className="mt-4 text-left text-5xl font-bold  text-[#2e657a] font-pj">What our happy clients say about us</h2>
            </div>
