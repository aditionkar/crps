          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li className="flex items-start">
                ...
                <span className="text-accent-lighter">+91 555-123-4567</span>
              </li>
            </ul>
            <form className="mt-6">
              ...
              <div className="flex overflow-hidden rounded-full shadow-md">
                <input
                  ...
                  type="email"
                  required
                  className="w-full appearance-none border-none bg-white px-4 py-2 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-accent rounded-l-full"
                  placeholder="Your email"
                />
                <button
                  type="submit"
                  className="bg-accent px-6 py-2 text-white rounded-r-full hover:bg-accent-light transition duration-300"
                >
                  Subscribe
                </button>
              </div>
